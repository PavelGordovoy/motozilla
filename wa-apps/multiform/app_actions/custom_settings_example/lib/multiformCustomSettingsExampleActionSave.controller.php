...
class multiformCustomSettingsExampleActionSaveController extends multiformActionsSave
{
    ...
    public function execute()
    {
        ...
        if ($action = $maf->getFormActions($this->form_id, $this->action_id, $this->parent_id)) {
            ...
            if (empty($data['my_text_field'])) {
                $this->addError(array('required' => _wd('multiform', "Fill in the required fields")), 'my_text_field');
            }
