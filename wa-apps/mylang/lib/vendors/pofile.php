...
{    // States for the .po file parser
    ...
    public function addMessage($message, $translation, $context = "")
    {
        ...
        $this->entries[$msgid] = ['msgid' => $msgid, 'msgctxt' => $context, 'msgstr' => $translation];
    }
    ...
    public function addMessages($messages)
    {
        foreach($messages as $key => $value)
        {
            ...
            {
                throw new Exception("Entry '$key':'$value' does not seem to describe a translation, either/both the key or/and value of the array must be a string.");
            }
        }
    }
        ...
        foreach($lines as $line)
        {
            ...
            else
            {
                ...
                else if($current_keyword[0] == '#')
                {
                    ...
                    {
                        $current_entry_data['comments'][$current_keyword] = [];
                    }
    ...
    {
        file_put_contents($path, (string)$this.PHP_EOL);
    }
