...
class sitemapSystemConfigPatcher_1533278860
{
	...
	public function backupCurrentConfig()
	{
		waFiles::copy($this->system_config_path, $this->system_config_backup_path . '_1533278860');
	}
