...
class sitemapEnumDataFieldSpecification implements sitemapIDataFieldSpecification
{
	private $enum_options;
	private $default_value;

	public function __construct(sitemapEnumOptions $enum_options, $default_value)
	{
