...
class sitemapJsonArrayDataFieldSpecification implements sitemapIDataFieldSpecification
{
	private $default_value = array();
	private $array_element_specification;

	public function __construct(sitemapIDataFieldSpecification $array_element_specification, $default_value = null)
	{
