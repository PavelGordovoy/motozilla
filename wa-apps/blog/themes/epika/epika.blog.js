$(function(){
    ...
    $('.comment-reply').live('click', function() {
        ...
        if (form_wrapper.is(":visible") && !form_wrapper.hasClass("new-comment")) {
            form_wrapper.hide();
        } else {
            form_wrapper.removeClass("new-comment");
    ...
    $('.write-comment a').live('click', function(){
        var form_wrapper = $('.comment-form');
        if(form_wrapper.is(":visible") && form_wrapper.hasClass("new-comment")) {
            form_wrapper.removeClass("new-comment");
            form_wrapper.hide();
        } else {
            form_wrapper.addClass("new-comment");
            move_form_add($(this).parent(), 0, true);
            form_wrapper.show();
        }
        return false;
    });
